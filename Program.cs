...
using SetecBackendCSharp.Middleware;
using SetecBackendCSharp.Repositories.Generic;
using SetecBackendCSharp.Repositories.Implements.Users;
using SetecBackendCSharp.Services.Implements.Users;

var builder = WebApplication.CreateBuilder(args);

Env.Load();

var firebaseKeyPath = Environment.GetEnvironmentVariable("FIREBASE_CREDENTIAL_PATH");
...
var appName = "Sr. Saúde";
var appVersion = "v1";
var description = "API do sistema Sr. Saúde";
